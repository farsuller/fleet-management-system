...
class MaintenanceRepositoryImpl : MaintenanceRepository {
    ...
    override suspend fun findById(id: MaintenanceJobId): MaintenanceJob? =
        dbQuery {
    ...
    override suspend fun findByJobNumber(jobNumber: String): MaintenanceJob? =
        dbQuery {
            MaintenanceJobsTable
                .join(VehiclesTable, JoinType.LEFT, MaintenanceJobsTable.vehicleId, VehiclesTable.id)
                .selectAll()
    ...
    override suspend fun saveJob(job: MaintenanceJob): MaintenanceJob =
        dbQuery {
            val exists =
                MaintenanceJobsTable
                    .selectAll()
    ...
    override suspend fun findAll(): List<MaintenanceJob> =
        dbQuery {
            MaintenanceJobsTable
                .join(VehiclesTable, JoinType.LEFT, MaintenanceJobsTable.vehicleId, VehiclesTable.id)
                .selectAll()
    ...
    override suspend fun findByVehicleId(vehicleId: VehicleId): List<MaintenanceJob> =
        dbQuery {
            MaintenanceJobsTable
                .join(VehiclesTable, JoinType.LEFT, MaintenanceJobsTable.vehicleId, VehiclesTable.id)
                .selectAll()
    ...
    override suspend fun findByStatus(status: MaintenanceStatus): List<MaintenanceJob> =
        dbQuery {
            MaintenanceJobsTable
                .join(VehiclesTable, JoinType.LEFT, MaintenanceJobsTable.vehicleId, VehiclesTable.id)
                .selectAll()
    ...
    override suspend fun findByAssignedUser(userId: UUID): List<MaintenanceJob> =
        dbQuery {
            MaintenanceJobsTable
                .join(VehiclesTable, JoinType.LEFT, MaintenanceJobsTable.vehicleId, VehiclesTable.id)
                .selectAll()
    ...
    override suspend fun findActiveIncidentsByVehicleId(vehicleId: VehicleId): List<VehicleIncident> =
        dbQuery {
            (VehicleIncidentsTable leftJoin VehiclesTable)
                .selectAll()
                .where {
    ...
    override suspend fun findIncidentsByVehicleId(vehicleId: VehicleId): List<VehicleIncident> =
        dbQuery {
            (VehicleIncidentsTable leftJoin VehiclesTable)
                .selectAll()
    ...
    override suspend fun findIncidentsByJobId(jobId: MaintenanceJobId): List<VehicleIncident> =
        dbQuery {
            (VehicleIncidentsTable leftJoin VehiclesTable)
                .selectAll()
    ...
    override suspend fun saveIncident(incident: VehicleIncident): VehicleIncident =
        dbQuery {
            val exists =
    ...
    override suspend fun findAllIncidents(status: IncidentStatus?): List<VehicleIncident> =
        dbQuery {
