...
class LocationHistoryRepository {
     ...
     */
    suspend fun saveTrackingRecord(state: VehicleRouteState): UUID =
        dbQuery {
     ...
     */
    suspend fun getVehicleHistoryCount(vehicleId: String): Long =
        dbQuery {
            LocationHistoryTable
                .selectAll()
                .where { LocationHistoryTable.vehicleId eq vehicleId }
     ...
     */
    suspend fun getLatestVehicleState(vehicleId: String): VehicleRouteState? =
        dbQuery {
            LocationHistoryTable
                .selectAll()
                .where { LocationHistoryTable.vehicleId eq vehicleId }
     ...
     */
    suspend fun getAllLatestVehicleStates(): List<VehicleRouteState> =
        dbQuery {
            val sql =
                """
