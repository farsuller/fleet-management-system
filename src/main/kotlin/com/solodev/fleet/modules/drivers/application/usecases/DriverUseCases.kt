...
class EndShiftUseCase(
    ...
    suspend fun execute(
        ...
        driverRepository.endShift(driverId, notes)
...
class GetActiveShiftUseCase(
    ...
    suspend fun execute(driverId: String): DriverShift? = driverRepository.findActiveShift(driverId)
}
...
class UpdateDriverUseCase(
    ...
    suspend fun execute(
        ...
        val existing =
            driverRepository.findById(DriverId(id))
