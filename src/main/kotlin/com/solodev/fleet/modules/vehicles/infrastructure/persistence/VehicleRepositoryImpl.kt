...
class VehicleRepositoryImpl(
    ...
    private fun Location.toPGgeometry(): PGgeometry = PGgeometry("SRID=4326;POINT($longitude $latitude)")
    ...
    override suspend fun deleteById(id: VehicleId): Boolean =
        dbQuery {
            val deletedCount =
    ...
    override suspend fun getOdometerHistory(vehicleId: VehicleId): List<OdometerReading> =
        dbQuery {
