...
class RecordDriverRemittanceUseCaseTest {
    ...
    @Test
    fun shouldCreateSubmittedRemittanceAndPostGL_WhenRequestIsValid(): Unit =
        runBlocking {
            // Arrange
    ...
    @Test
    fun shouldMarkInvoicePaid_WhenPaymentFullySettlesInvoice(): Unit =
        runBlocking {
            // Arrange
            val paymentId = UUID.randomUUID()
    ...
    @Test
    fun shouldKeepInvoiceIssued_WhenPaymentPartiallySettlesInvoice(): Unit =
        runBlocking {
            // Arrange
            val paymentId = UUID.randomUUID()
