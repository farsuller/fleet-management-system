...
class ReconciliationServiceTest {
    ...
    @Test
    fun shouldReturnEmptyList_WhenInvoicePaidAmountMatchesLedger() =
        runBlocking {
            // Arrange
    ...
    @Test
    fun shouldReturnMismatch_WhenPaidAmountDiffersFromLedger(): Unit =
        runBlocking {
            // Arrange
            val invoiceId = UUID.randomUUID()
    ...
    @Test
    fun shouldReturnEmptyList_WhenARAccountNotFound() =
        runBlocking {
            // Arrange
    ...
    @Test
    fun shouldReturnTrue_WhenAccountingEquationHolds(): Unit =
        runBlocking {
    ...
    @Test
    fun shouldReturnFalse_WhenAccountingEquationDoesNotHold(): Unit =
        runBlocking {
