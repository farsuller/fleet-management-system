...
class ListVehicleMaintenanceUseCaseTest {
    ...
    @Test
    fun shouldReturnJobs_WhenVehicleHasMaintenance(): Unit =
        runBlocking {
            // Arrange
    ...
    @Test
    fun shouldReturnEmptyList_WhenVehicleHasNoMaintenance() =
        runBlocking {
            // Arrange
    ...
    @Test
    fun shouldQueryByCorrectVehicleId_WhenVehicleIdIsProvided(): Unit =
        runBlocking {
            // Arrange
