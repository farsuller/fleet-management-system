...
class UpdateVehicleUseCaseTest {
    ...
    @Test
    fun shouldUpdateLicensePlate_WhenVehicleExists(): Unit =
        runBlocking {
            // Arrange
    ...
    @Test
    fun shouldConvertDailyRateToCents_WhenDailyRateProvided(): Unit =
        runBlocking {
            // Arrange
    ...
    @Test
    fun shouldPreserveUnchangedFields_WhenPartialUpdateProvided(): Unit =
        runBlocking {
            // Arrange
    ...
    @Test
    fun shouldUpdateMakeModelAndYear_WhenProvided(): Unit =
        runBlocking {
            // Arrange
